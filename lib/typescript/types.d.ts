...
type type_dashboard_config = config_websocket_create | config_websocket_server | node_childProcess_ExecException | node_error | number | server | services_dashboard_activate | socket_summary | type_external_port[];
...
type type_service = "dashboard-action" | "dashboard-status" | "dashboard-terminal" | "process-kill" | "youtube-download-status" | "youtube-download";
type type_socket_data = services_dashboard_action | services_dashboard_status | services_dashboard_terminal | services_processKill | services_youtubeDownload | services_youtubeStatus;
